...
public class LoginServlet extends HttpServlet {
    ...
    private static final String ADMIN_PAGE = "DashBoard.jsp";
    private static final String OWNER_PAGE = "DashBoard.jsp";
    private static final String TECHNICIAN_PAGE = "DashBoard.jsp";
    private static final String VIEWER_PAGE = "DashBoard.jsp";
