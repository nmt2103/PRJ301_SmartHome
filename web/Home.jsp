...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    ...
    <form action="HomeServlet" style="margin: 0;">
...
<%
    ...
    if (successMsg != null && !successMsg.isEmpty()) { out.print("<div class='msg msg-success'>✅ " + successMsg + "</div>"); }
    if (errorMsg != null && !errorMsg.isEmpty()) { out.print("<div class='msg msg-error'>❌ " + errorMsg + "</div>"); }
%>
        ...
        <%
            ...
            if (homeList != null && !homeList.isEmpty()) {
                for (HomeDTO home : homeList) {
                    String statusClass = ("ACTIVE".equalsIgnoreCase(home.getStatus()) || "active".equalsIgnoreCase(home.getStatus())) ? "btn-active" : "btn-inactive";
        %>
        <tr>
            ...
            <td>
                <div class="action-forms">
                    ...
                    <form action="HomeServlet" method="POST" onsubmit="return confirm('Are you sure you want to delete this home?');">
