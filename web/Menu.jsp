...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="HomeServlet?action=search" class="nav-link"><i class="fas fa-building"></i> Quản lý Nhà</a></li>
            <li class="nav-item"><a href="RoomServlet?action=search" class="nav-link"><i class="fas fa-couch"></i> Quản lý Phòng</a></li>
            <li class="nav-item"><a href="DeviceServlet?action=search" class="nav-link"><i class="fas fa-lightbulb"></i> Quản lý Thiết bị</a></li>
            <li class="nav-item"><a href="HomeModeServlet?action=search" class="nav-link"><i class="fas fa-moon"></i> Chế độ (Modes)</a></li>
        </ul>
    </aside>
    ...
    <main class="main-content">
        <header class="header">
            ...
            <div class="header-actions">
                ...
                <form action="LoginServlet" style="margin:0;">
